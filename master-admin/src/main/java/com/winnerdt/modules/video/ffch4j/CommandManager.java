package com.winnerdt.modules.video.ffch4j;


import com.winnerdt.modules.video.ffch4j.commandbuidler.CommandAssembly;
import com.winnerdt.modules.video.ffch4j.commandbuidler.CommandBuidler;
...
import com.winnerdt.modules.video.ffch4j.handler.TaskHandler;

import java.util.Collection;
import java.util.Map;

import static com.winnerdt.modules.video.ffch4j.util.PropertiesUtil.load;
...
public interface CommandManager{
	ProgramConfig config = load("loadFFmpeg.properties", ProgramConfig.class);
	/**
	 * 注入自己实现的持久层
	 *
	 * @param taskDao
